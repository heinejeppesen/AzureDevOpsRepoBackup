...
And relying on developer devices for backup isn't a serious option.
...
The script provides:
  - Retrieving Personal Access Token for DevOps access from Azure Keyvault.
  - Exporting repositories as ZIP files from all or specific projects, provided the Personal Access Token has access to it.
  - Uploading exported files to Azure Storage Account as blobs.
